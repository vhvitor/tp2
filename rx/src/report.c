...
const char *report_format_to_string(const Report *report) {
    /** \brief
     *
     * \param
     * \param
    ...
    int exam_id = report_get_exam_id(report->current_exam);
    char *exam_condition = get_exam_condition_per_code(report->condition);
...
const int report_get_id(const Report *report) {
    /** \brief
     *
     * \param
     * \param
...
const int report_get_condition(const Report *report) {
    /** \brief
     *
     * \param
     * \param
...
const int report_get_timestamp(const Report *report) {
    /** \brief
     *
     * \param
     * \param
...
const int report_get_exam_id(const Report *report) {
    /** \brief
     *
     * \param
     * \param
